  ...
  let t = function () {
      ...
      t.submit(function (o) {
        o.preventDefault(),
          $.ajax({
            ...
            success: function (t) {
              let o = e(t.data.post);
              $("#posts-list-container>ul").prepend(o),
                n($(" .delete-post-button", o)),
                new PostComments(t.data.post._id),
    ...
    o = function () {
      $("#posts-list-container>ul>li").each(function () {
        let t = $(this),
          e = $(" .delete-post-button", t);
        n(e);
        let o = t.prop("id").split("-")[1];
        new PostComments(o);
      });
    };
  t(), o();
